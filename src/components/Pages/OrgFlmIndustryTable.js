      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/org-flm-industry-view")}>View</button>
            </td>
          </tr>
...
export default OrgFlmIndustryTable;
