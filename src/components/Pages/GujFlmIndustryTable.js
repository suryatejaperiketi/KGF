      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/guj-flm-industry-view")}>View</button>
            </td>
          </tr>
...
export default GujFlmIndustryTable;
