      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/andhra-agri-table-view")}>View</button>
            </td>
          </tr>
...
export default AndhraAgriTable;
