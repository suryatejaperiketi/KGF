      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/andhra-others-table-view")}>View</button>
            </td>
          </tr>
...
export default AndhraOthersTable;
