      ...
      <div className="student-view-card">
        ...
        <div className="double-section">
          ...
          <div className="info-box">
            ...
            <p><span>College Name :-</span> Geetham</p>
            <p><span>Department :-</span> ECE</p>
          </div>

          <div className="info-box">
            <h4>&nbsp;</h4>
            <p><span>Job Seeker :-</span> Yes</p>
            <p><span>Designation :-</span> BTech</p>
            <p><span>Year of Passout :-</span> --</p>
          </div>
        ...
        <div className="bottom-line">
          ...
          <p><span>Name of Organization :-</span> Kamma Community</p>
        </div>
...
export default TelanganaStTableView