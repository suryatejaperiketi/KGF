      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/osi-flm-industry-view")}>View</button>
            </td>
          </tr>
...
export default OsiFlmIndustryTable;
