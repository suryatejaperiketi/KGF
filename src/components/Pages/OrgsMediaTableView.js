      ...
      <div className="student-view-card">
        ...
        <div className="double-section">
          ...
          <div className="info-box">
            ...
            <p><span>Occupation :-</span>Media</p>
            <p><span>Type of Work :-</span>Reporter</p>
          </div>


          <div className="info-box">
            <h4>&nbsp;</h4>
            <p><span>Role Type :-</span>Reporter</p>
          </div>
...
export default OrgsMediaTableView;
