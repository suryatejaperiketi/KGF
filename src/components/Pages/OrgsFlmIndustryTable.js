...
const OrgsFlmIndustryTable = () => {
    const navigate = useNavigate();
  return (
    <div className='admin-student-table-container'>
      <h2>Film Industry Table</h2>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Ameerpet</td>
            <td>
          <button className='atview-btn' onClick={()=> navigate("/admindashboard/orgs-flm-industry-view")}>View</button>
            </td>
          </tr>
...
export default OrgsFlmIndustryTable;
