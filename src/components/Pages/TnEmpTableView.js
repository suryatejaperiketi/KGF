      ...
      <div className="student-view-card">
        ...
        <div className="double-section">
          ...
          <div className="info-box">
            ...
            <p><span>Employee Type :-</span> Private</p>
            <p><span>Designation :-</span>Intern</p>
            <p><span>District/City :-</span>Hi-tech City</p>
          </div>


          <div className="info-box">
            <h4>&nbsp;</h4>
            <p><span>Job Seeker :-</span>No</p>
            <p><span>Company Name :-</span> Ysk</p>
            <p><span>Office Location :-</span>Hyderabad</p>
          </div>
...
export default TelanEmpTableView